...
<head>
    <meta charset="UTF-8">
    <title>Главная</title>
    <link href="../1282861-yeticave-12/css/normalize.min.css" rel="stylesheet">
    <link href="../1282861-yeticave-12/css/style.css" rel="stylesheet">
</head>
<body>
...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <a class="main-header__logo">
            <img src="../1282861-yeticave-12/img/logo.svg" width="160" height="39" alt="Логотип компании YetiCave">
        </a>
        ...
        <a class="main-header__add-lot button" href="../1282861-yeticave-12/pages/add-lot.html">Добавить лот</a>

        <nav class="user-menu">
        <?php   if ($is_auth == 1): ?>
            <div class="user-menu__logged">
                <p>Sergey</p>
                <a class="user-menu__bets" href="../1282861-yeticave-12/pages/my-bets.html">Мои ставки</a>
    ...
    <section class="promo">
        ...
        <ul class="promo__list">
            ...
            <li class="promo__item promo__item--boards">
                <a class="promo__link" href="../1282861-yeticave-12/pages/all-lots.html"><?=$categories[$index];?></a>
                <?php $index++; ?>
                <?php endwhile; ?>
            </li>
        </ul>
        ...
        <ul class="lots__list">
            ...
            $goods = [
                [
                    ...
                    "price" => 10999,
                    "image" => "../1282861-yeticave-12/img/lot-1.jpg"
                ],
                [
                    "title" => "DC Ply Mens 2016/2017 Snowboard",
                    "categories" => "Доски и лыжи",
                    "price" => 15999,
                    "image" => "../1282861-yeticave-12/img/lot-2.jpg"
                ],
                [
                    "title" => "Крепления Union Contact Pro 2015 года размер L/XL",
                    "categories" => "Крепления",
                    "price" => 8000,
                    "image" => "../1282861-yeticave-12/img/lot-3.jpg"
                ],
                [
                    "title" => "Ботинки для сноуборда DC Mutiny Charocal",
                    "categories" => "Ботинки",
                    "price" => 10999,
                    "image" => "../1282861-yeticave-12/img/lot-4.jpg"
                ],
                [
                    "title" => "Куртка для сноуборда DC Mutiny Charocal",
                    "categories" => "Одежда",
                    "price" => 7500,
                    "image" => "../1282861-yeticave-12/img/lot-5.jpg"
                ],
                [
                    "title" => "Маска Oakley Canopy",
                    "categories" => "Разное",
                    "price" => 5400,
                    "image" => "../1282861-yeticave-12/img/lot-6.jpg"
                ]
            ];
            ...
            <li class="lots__item lot">
                ...
                <div class="lot__info">
                    ...
                    <h3 class="lot__title"><a class="text-link" href="../1282861-yeticave-12/pages/lot.html">Название товара</a></h3>
...
<footer class="main-footer">
    <nav class="nav">
        <ul class="nav__list container">
            ...
            <!--заполните этот список из массива категорий-->
            <li class="nav__item">
                <a href="../1282861-yeticave-12/pages/all-lots.html"><?=$categories[$index];?></a>
                <?php $index++; ?>
                <?php endwhile; ?>
            </li>
        </ul>
    ...
    <div class="main-footer__bottom container">
        ...
        <a class="main-footer__add-lot button" href="../1282861-yeticave-12/pages/add-lot.html">Добавить лот</a>
